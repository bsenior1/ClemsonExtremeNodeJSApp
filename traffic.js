	...
	self.getTraffic = function(request, response)
	{
		...
		else
		{
			...
			function (error, response, body) {
				...
				deviceClient.publish("status","json",'{"d":{"type" : "traffic", "description" : '+body.resourceSets[0].description+',"severity" : '+body.resourceSets[0].severity+',"roadClosed" : '+body.resourceSets[0].roadClosed'}}');
			});	
		}
